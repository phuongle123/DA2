<table class="table table-hover">
    ...
    mysqli_query($connect,'SET NAMES UTF8');
      ...
      $id_dmuc = $_GET['id_dmuc'];

      $query = "SELECT * from thong_tin_cv, chuyen_nghanh  where chuyen_nghanh.ma_chuyen_nghanh = thong_tin_cv.ma_chuyen_nghanh and id_dmuc='$id_dmuc' ";
